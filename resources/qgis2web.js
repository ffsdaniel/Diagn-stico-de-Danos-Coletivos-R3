...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31983',
            //extent: [-44.876750, -19.987442, 589348.429987, 7880953.280535],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([492021.065255, 7793708.695285, 615883.105010, 7882438.230613], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Diagnóstico de Danos Coletivos da Região 3</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_pontos_comunidades_3,
    colName: 'Comunidade',
    zoom: 10,
    collapsed: true,
    map: map
